...
public class ShortUrlGenerator {
    private static final Log log = LogFactory.getLog(ShortUrlGenerator.class);

    public static String generator(String url) {
        return  shortUrl(url)[0];
    }

    public static String generatorAllStr(String url) {
        String[] shorts = shortUrl(url);
        String re = "";
