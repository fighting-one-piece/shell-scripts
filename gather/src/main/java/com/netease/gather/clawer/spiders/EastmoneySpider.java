...
public class EastmoneySpider {
    ...
    private static final Logger logger = Logger.getLogger(EastmoneySpider.class);

    public static List<Doc> clawFinance() throws Exception{
        return spiderCtrl("http://roll.eastmoney.com/_.html?rt=" + Math.random(),"finance");
    }
    ...
    private static List<Doc> commonSpider(String url,String channel) throws Exception{
        ...
        Elements docs = document.select("li:has(a)");
