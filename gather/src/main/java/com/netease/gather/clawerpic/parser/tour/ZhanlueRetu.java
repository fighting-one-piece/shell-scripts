...
//战略网-论坛热图列表
public class ZhanlueRetu extends AbstractParser{
	
	private static final String PAGE_CHARSET = "UTF-8";
	private static final String DOMAIN = "http://www.chinaiiss.com/list/237.html";
	...
	public List<PictureSet> getNewPictureSet(PictureSet lastPictureSet) {
		...
		for(int i = 1 ; i <= page ;i++){
			...
			String url = "http://www.chinaiiss.com/list/237/" + i + ".html";
			...
			for(Element one : ones){
				...
				if(temp.attr("href").contains("pic.chinaiiss.com") || temp.attr("href").contains("club.chinaiiss.com")){
