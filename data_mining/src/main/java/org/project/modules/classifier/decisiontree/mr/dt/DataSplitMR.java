...
public class DataSplitMR {
	
	private static void configureJob(Job job) {
		job.setJarByClass(DataSplitMR.class);
...
class DataSplitMapper extends Mapper<LongWritable, Text, 
	LongWritable, Text> {
...
class DataSplitReducer extends Reducer<LongWritable, Text, NullWritable, Text> {
	...
	protected void reduce(LongWritable key, Iterable<Text> values,
		...
		context.write(NullWritable.get(), new Text(outputDir));
	}
