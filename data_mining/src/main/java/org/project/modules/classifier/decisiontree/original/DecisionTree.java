package org.project.modules.classifier.decisiontree.original;
...
public class DecisionTree {
	...
	public static Object decision (Object decisionTree, Object[] data, String[] attributes) {
		...
		int index = obtainAttributeIndex(attributes, attribute);
		if (index == -1) return null;
		for (Object subAttribute : tree.getAttributeValues()) {
			if (null == subAttribute || !subAttribute.equals(data[index])) {
				continue;
			}
			Object child = tree.getChild(subAttribute);
	...
	private static int obtainAttributeIndex(String[] attributes, String attribute) {
		int index = -1;
